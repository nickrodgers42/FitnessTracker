...
import { formatSeconds, coordDistance, formatDate, toKmph, sameDay, consecutiveDays } from '../models/utilFunctions';
...
class ActivityDetail extends Component {
    ...
    render() {
        ...
        let d = formatDate(this.props.activity.date);
        ...
        if (this.props.activity.photo == null) {
            shareImageBase64.url = REACT_ICON
        }
        else {
            shareImageBase64.url = this.props.activity.photo  
        }

        console.log(shareImageBase64.uri)
            ...
            <Container>
                    ...
                    <Grid>
                        ...
                        <Row>
                            ...
                            <Col>
                                ...
                                >
                                    <Icon name='share' style={{fontSize: 60, textAlign: 'center'}} />
                                </Button>
                            </Col>
                        </Row>
                    </Grid>
                ...
                <ShareSheet visible={this.state.visible} onCancel={this.onCancel.bind(this)}>
                    ...
                    <ShareButton
                        ...
                        }}>Copy Link</ShareButton>
                    <ShareButton iconSrc={{ uri: MORE_ICON }}
                        onPress={() => {
                            this.onCancel();
                            setTimeout(() => {
